...
## ১. Interface = মেইন ব্লুপ্রিন্ট (কাগজে-কলমে)
ইঞ্জিনিয়াররা একদম শুরুতে টেবিল বা কাগজে খসড়া নকশা করলেন: "গাড়ির চারটা চাকা থাকবে, একটা স্টিয়ারিং থাকবে, ব্রেক থাকবে।"

* Static মেথডের লজিক: এই কাগজে-কলমে নকশার ভেতরেই একটা গ্লোবাল স্ট্যান্ডার্ড বা নিয়ম ফিক্সড করে দেওয়া হলো (যেমন: "সব গাড়ি চাকার জন্য রাবার ব্যবহার করবে"—এটা বদলানো যাবে না)। এটা হলো ইন্টারফেসের static মেথড বা কনস্ট্যান্ট ভ্যারিয়েবল।

## ২. Class = প্রোটোটাইপ (Prototype)
নকশা দেখে ফ্যাক্টরি বা ল্যাবে প্রথম একটা টেস্ট মডেল বা প্রোটোটাইপ তৈরি করা হলো। এখানে ইঞ্জিনের ভেতরের তার কীভাবে জোড়া লাগবে, মেটাল বডি কীভাবে ফিক্সড হবে (কোডের বডি বা লজিক) সবকিছু সম্পূর্ণ স্ট্রাকচার করা হলো। এটা হলো আপনার Class। প্রোটোটাইপ নিজে রাস্তায় চলে না, কিন্তু এটা আসল গাড়ি বানানোর জন্য একদম রেডি স্ট্রাকচার।
## ৩. Object = রিয়েল অবজেক্ট (Real Object)
ওই প্রোটোটাইপ (Class) সফলভাবে কাজ করার পর ফ্যাক্টরির অ্যাসেম্বলি লাইন থেকে লাখ লাখ গাড়ি তৈরি হয়ে শোরুমে চলে আসলো। যেমন আপনার কেনা লাল রঙের টয়োটা গাড়িটি, যেটায় আপনি চাবি দিয়ে স্টার্ট দিচ্ছেন এবং ড্রাইভ করছেন। এটিই হলো আসল Object বা মেমোরিতে জায়গা নেওয়া রিয়াল এলিমেন্ট।

![alt text](image.png)

------------------------------
## এক নজরে আপনার তৈরি করা মেমোরি ম্যাপ:

| আপনার থিওরি | জাভার রূপ | বাস্তব উদাহরণ (গাড়ি) |
|---|---|---|
| মেইন ব্লুপ্রিন্ট | interface Vehicle | কাগজের নকশা + গ্লোবাল স্ট্যান্ডার্ড |
| প্রোটোটাইপ | class ToyotaCar | টেস্ট মডেল (সব মেথডের আসল কোড রেডি) |
| রিয়াল অবজেক্ট | new ToyotaCar() | শোরুম থেকে কেনা আপনার নিজের গাড়িটি |
