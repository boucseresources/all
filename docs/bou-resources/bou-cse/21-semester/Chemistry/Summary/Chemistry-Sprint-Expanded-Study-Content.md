# Chemistry Sprint — Expanded Bilingual Study Guide
...
>
> **ব্যবহার:** এটি Chemistry Sprint ওয়েবসাইটের বিস্তারিত content source। মূল study sheet-এর ধারণা অক্ষুণ্ণ রেখে সহজ ব্যাখ্যা, তুলনা, ধাপে ধাপে হিসাব, মনে রাখার কৌশল ও পরীক্ষাভিত্তিক প্রশ্ন যোগ করা হয়েছে।

---

## How to use this guide / কীভাবে পড়বে

1. Read the **Exam-eve gist** first. / প্রথমে **পরীক্ষার আগের সারাংশ** পড়ো।
...
| Element | Pure substance that cannot be chemically broken into simpler substances | রাসায়নিকভাবে সরল পদার্থে ভাঙা যায় না | H, O, Fe |
...
নিউক্লিয়াস আয়তনে খুব ছোট হলেও পরমাণুর প্রায় সম্পূর্ণ ভর বহন করে। নিরপেক্ষ পরমাণুতে proton ও electron সমান। Electron হারালে cation এবং গ্রহণ করলে anion হয়।
...
## অধ্যায় ০২ — পর্যায় সারণি ও পর্যায়বৃত্ত ধর্ম
...
## অধ্যায় ০৪ — কঠিনের ত্রুটি ও অর্ধপরিবাহী
...
## অধ্যায় ০৫ — রাসায়নিক সাম্য ও তাপ-রসায়ন
...
## অধ্যায় ০৭ — pH ও দ্রবণের ঘনমাত্রা
...
## অধ্যায় ০৮ — জৈব রসায়নের বিক্রিয়া
